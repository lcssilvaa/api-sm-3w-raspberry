...
public class MedicaoDTO {
    ...
    private BigDecimal epa_c;
    private BigDecimal epb_c;
    private BigDecimal epc_c;
    private BigDecimal ept_c;

    private BigDecimal epa_g;
    private BigDecimal epb_g;
    private BigDecimal epc_g;
    private BigDecimal ept_g;
    ...
    public BigDecimal getEpa_c() {
        return epa_c;
    }

    public void setEpa_c(BigDecimal epa_c) {
        this.epa_c = epa_c;
    }

    public BigDecimal getEpb_c() {
        return epb_c;
    }

    public void setEpb_c(BigDecimal epb_c) {
        this.epb_c = epb_c;
    }

    public BigDecimal getEpc_c() {
        return epc_c;
    }

    public void setEpc_c(BigDecimal epc_c) {
        this.epc_c = epc_c;
    }

    public BigDecimal getEpt_c() {
        return ept_c;
    }

    public void setEpt_c(BigDecimal ept_c) {
        this.ept_c = ept_c;
    }

    public BigDecimal getEpa_g() {
        return epa_g;
    }

    public void setEpa_g(BigDecimal epa_g) {
        this.epa_g = epa_g;
    }

    public BigDecimal getEpb_g() {
        return epb_g;
    }

    public void setEpb_g(BigDecimal epb_g) {
        this.epb_g = epb_g;
    }

    public BigDecimal getEpc_g() {
        return epc_g;
    }

    public void setEpc_g(BigDecimal epc_g) {
        this.epc_g = epc_g;
    }

    public BigDecimal getEpt_g() {
        return ept_g;
    }

    public void setEpt_g(BigDecimal ept_g) {
        this.ept_g = ept_g;
    }
    ...
    public BigDecimal getRssi_wifi() {
        return rssi_wifi;
    }

    public void setRssi_wifi(BigDecimal rssi_wifi) {
